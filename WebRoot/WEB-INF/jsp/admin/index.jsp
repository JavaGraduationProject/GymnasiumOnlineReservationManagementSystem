...
<![endif]-->
<title>体育馆在线预订系统</title>
</head>
<body style="overflow:hidden">
<header class="Hui-header cl"> <a class="Hui-logo l" title="体育馆在线预订系统" href="/">体育馆在线预订系统</a>  <span class="Hui-userbox"><span class="c-white">(${adminBean.username })</span>
 <a class="btn btn-danger radius ml-10" href="${ctx }/adminLogin/out.html" title="退出"><i class="icon-off"></i> 退出</a></span> 
  ...
  <aside class="Hui-aside" style="">
    ...
    <div class="menu_dropdown bk_2">
      ...
      <dl id="menu-system">
        ...
        <dd>
          <ul>
            <li><a _href="${ctx}/admin/password.html" href="javascript:void(0)">修改密码</a></li>
          </ul>
        </dd>
      </dl>
      <dl id="menu-system">
        <dt><i class="icon-cogs"></i>用户管理<b></b></dt>
        <dd>
          <ul>
            <li><a _href="${ctx}/admin/customer/frame.html?flag=1" href="javascript:void(0)">客户列表</a></li>
          </ul>
        </dd>
      </dl>
      <dl id="menu-system">
        ...
        <dd>
          <ul>
            <li><a _href="${ctx}/admin/lbt/frame.html?flag=1" href="javascript:void(0)">轮播图列表</a></li>
          </ul>
        </dd>
      </dl>
      <dl id="menu-system">
        <dt><i class="icon-cogs"></i>场地预订订单管理<b></b></dt>
        <dd>
          <ul>
            <li><a _href="${ctx}/admin/productlist/frame.html?flag=1" href="javascript:void(0)">订单列表</a></li>
            <li><a _href="${ctx}/admin/tj/tj1.html" href="javascript:void(0)">场地预定统计</a></li>
          </ul>
        </dd>
      </dl>
      <dl id="menu-system">
        ...
        <dd>
          <ul>
            <li><a _href="${ctx}/admin/product/frame.html?flag=1" href="javascript:void(0)">场地列表</a></li>
          </ul>
        </dd>
      </dl>
      <dl id="menu-system">
        ...
        <dd>
          <ul>
            <li><a _href="${ctx}/admin/zx/frame.html?flag=1" href="javascript:void(0)">通知列表</a></li>
          </ul>
        </dd>
      </dl>
       <dl id="menu-system">
        <dt><i class="icon-cogs"></i>财务报表管理<b></b></dt>
        <dd>
          <ul>
            <li><a _href="${ctx}/admin/tj/tj2.html" href="javascript:void(0)">金额线形图统计</a></li>
          </ul>
        </dd>
      </dl>
      <%--<dl id="menu-system">
